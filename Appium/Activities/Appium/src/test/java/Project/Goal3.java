...
public class Goal3 {
	...
	public void createNote(String title, String desc) throws InterruptedException {
		...
		String reminder = driver.findElement(By.id("reminder_chip_text")).getText();
		System.out.println("This is the "+reminder);
		// String
	...
	public static Object[][] credentials() {
		return new Object[][] { { "Team Title", "Team Description" } };
	}
